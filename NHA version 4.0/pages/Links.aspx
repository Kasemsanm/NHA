<%@ Page Title="" Language="C#" MasterPageFile="~/siteMaster.Master" AutoEventWireup="true" CodeBehind="Links.aspx.cs" Inherits="NHA_version_4._0.pages.Links" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="container mb-5 pt-5">
        <div class="flex-center">
            <h2 class="font-weight-bold mt-lg-5 mb-3 pb-4"><strong>Links</strong></h2>
        </div>
